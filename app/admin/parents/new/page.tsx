...
export default function NewParentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Link selected students to this parent record. Note: this "parentUid"
      // is the parent's Firestore document id, used to look up children via
      // getChildrenForParent(). If you later create a login for this parent,
      // that's a separate Firebase Auth uid stored as this parent record's
      // own "authUid" field — the two are different ids used for different purposes.
  ...
  return (
    <div className="max-w-xl space-y-4">
      ...
      <p className="text-sm text-gray-500 bg-brand/5 rounded-lg px-3 py-2">This creates the parent&apos;s contact record and links any children you select below. Use
        "Create Login" from the Parents list afterward to give them portal access.
      </p>
