...
* Change class.
* 
* Changing the class clears the previous students,
* subjects and scores because results belong to a
* specific class.
  */
...
* Load students and existing results whenever the
* selected class/subjects change.
  */
  useEffect(() => {
...
Results Management
    ...
    <p className="text-sm text-gray-500 mt-1">
      Administrator &middot; {session} &middot; {term}
    </p>
  </div>
  ...
  <div className="bg-brand/5 rounded-lg px-4 py-3">
    <p className="text-sm text-brand-dark">
      As an administrator, you can enter and manage
      results for any class and any subject.
    </p>
  </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Select one or more subjects to enter or
            manage results.
          </p>
        </div>
    ...
    (!classId ||
      ...
      <div className="bg-white rounded-card border border-gray-100 shadow-sm p-6">
        ...
        <ol className="mt-2 space-y-1 text-sm text-gray-500 list-decimal list-inside">
          ...
          <li>
            Switch between subjects using the
            subject tabs.
          </li>

          <li>
            Click Save to save all selected
            subjects.
          </li>
        </ol>
      </div>
